...
export const CONTACT_INFO = {
  ...
  email: 'abbycakesandhampers@gmail.com',
  location: 'Lekki Phase 1 & Victoria Island, Lagos, Nigeria',
  deliveryCoverage: 'Prompt Delivery across Lagos & Nationwide Dispatch for Hampers',
  pickupAddress: 'Abby Studio: Lekki Phase 1, Lagos, Nigeria (By Appointment & Pre-Orders)',
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    cakeOrMenu: 'Bespoke Akankemi Rose Gold Cake (₦65,000) & Royal Hamper (₦55,000)',
  ...
  },
  {
    ...
    cakeOrMenu: 'Floral Pastel Party Cake (₦50,000) & Treat Boxes',
